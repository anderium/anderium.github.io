...
<!--
Because I don't want to edit the numbers every time, let markdown handle the actual list numbers.  Format:
...
1. **Double The Mines** by *Florian Wortmann*.  [Play](https://app.crackingthecryptic.com/sudoku/T3tMM749d7), [hint one](# "I forgot that the line from r3c5 to r8c6 didn't have to be all different numbers.  That caused me to place an 8 in r8c6, which is impossible according to the rules!"), [hint two](# "The way to make a circle have 2 in it is to place the mines on opposite orthogonal edges to the cell."), 61 min + ≈30 min before first hint.
1. **Wormholes (remix)** by *Nordy*.  [Play](https://app.crackingthecryptic.com/sudoku/rT277BN3dF), no hints, 85 min.
1. **Glyphs #5** by *damasosos92*.  [Play](https://app.crackingthecryptic.com/sudoku/bjD8gPPjqG), one [“hint”](# "I forgot one possibility and that happened to be a thought required for the solution, at least that's what I remember."), 103 min.
1. **Madrigal** by *Fafrd*.  [Play](https://app.crackingthecryptic.com/sudoku/tGqm6F2nPN), one [“hint”](# "I didn't believe one of my deduction and thought it meant that there was no solution, I was wrong and could have figured that out myself easily."), 77 min.
1. **An Easter Miracle** by *Farkov and TopAutism*.  [Play](https://app.crackingthecryptic.com/sudoku/3BqbqHQq3B), no hints?, 144 min.
1. **Overheating** by *Christounet*.  [Play](https://app.crackingthecryptic.com/sudoku/mGLB4pqJt4), no hints?, 42 min.
1. **Blackout** by *Jay Dyer*.  [Play](https://app.crackingthecryptic.com/sudoku/h9q22bptmF), one [“hint”](# "If you can see part of the clue, you can already use that you see that part, even if the clue isn't for that specific cell."), 86 min.
1. **Self-determination** by *Stephane Bura*.  [Play](https://app.crackingthecryptic.com/sudoku/8L2Pmn44rp), no hints?, ?? min.
1. **Tetris Sudoku** by *Trevor Nicholas*.  [Play](https://sudokupad.app/TetrisSudokuTrevorNicholas?setting-conflictchecker=0), no hints, 60 min.
1. **SYO Sum Lines** by *Xendari*.  [Play](https://app.crackingthecryptic.com/sudoku/H2Lb4hnFgm), no hints?, 64 min.
